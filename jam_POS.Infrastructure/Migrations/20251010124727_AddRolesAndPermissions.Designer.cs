...
namespace jam_POS.Infrastructure.Migrations
{
    ...
    [Migration("20251010124727_AddRolesAndPermissions")]
            ...
            modelBuilder.Entity("jam_POS.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            LastName = "Admin",
                            PasswordHash = "$2a$11$uAFVsuH6DAGm1pPN0OrKTe5AXO1jfhRq9Qo8KvhMOwc/WoioESGMu",
                            RoleId = 1,
                            Username = "admin"
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            LastName = "Seller",
                            PasswordHash = "$2a$11$7ufCCV.s2T3H3lQPP5Pbze0zroGfRa3YoxAzu83YQuacIrLLIZap6",
                            RoleId = 2,
                            Username = "seller"
                        });
                });
