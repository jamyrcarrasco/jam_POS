...
namespace jam_POS.Infrastructure.Migrations
{
    ...
    [Migration("20251010142456_AddMultiTenantToAllEntities")]
    partial class AddMultiTenantToAllEntities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("jam_POS.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            LastName = "Admin",
                            PasswordHash = "$2a$11$q2iRAqq.iN8f/kx2VzmPnO9k6Yl3uqVGje4PfnktK/SCzTfzjUduG",
                            RoleId = 1,
                            Username = "admin"
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            LastName = "Seller",
                            PasswordHash = "$2a$11$oeOflqse0U8ZTFYD2tNvWuhpcdcE5wR6sWkX.ZCMiqoRUmuNTvM/y",
                            RoleId = 2,
                            Username = "seller"
                        });
                });
