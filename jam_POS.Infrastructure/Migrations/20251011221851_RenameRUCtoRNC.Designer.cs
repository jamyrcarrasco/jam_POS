...
namespace jam_POS.Infrastructure.Migrations
{
    ...
    [Migration("20251011221851_RenameRUCtoRNC")]
    partial class RenameRUCtoRNC
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("jam_POS.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            LastName = "Admin",
                            PasswordHash = "$2a$11$7cfSAsKKN57V3TT1np3Sze4kdy.vFzIvdloLIYcNbRREX/FeczMgO",
                            RoleId = 1,
                            Username = "admin"
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            LastName = "Seller",
                            PasswordHash = "$2a$11$Rt4faDjitVumppza5BR1ZujXxG0NK4oHyecEWTfQqrnWM1U6JeZ4C",
                            RoleId = 2,
                            Username = "seller"
                        });
                });
