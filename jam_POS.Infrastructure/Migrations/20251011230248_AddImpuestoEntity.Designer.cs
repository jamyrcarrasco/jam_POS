...
namespace jam_POS.Infrastructure.Migrations
{
    ...
    [Migration("20251011230248_AddImpuestoEntity")]
    partial class AddImpuestoEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("jam_POS.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            LastName = "Admin",
                            PasswordHash = "$2a$11$RO.XgaeqNhtc0acHac6EoOII4r/tBSwEl/5MNmPHeXd.2gKefywNa",
                            RoleId = 1,
                            Username = "admin"
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            LastName = "Seller",
                            PasswordHash = "$2a$11$8FTf2TaMXEzWHG.eTVJCMeQ58nRg28Wt9HEZG41Yrc2osmcoMnJdC",
                            RoleId = 2,
                            Username = "seller"
                        });
                });
